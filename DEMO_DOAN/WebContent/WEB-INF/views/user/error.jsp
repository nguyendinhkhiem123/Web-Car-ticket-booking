		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li ><a class="nav-link" href="home/${id}.htm">TRANG CHỦ
							
					</a></li>
					<li class="nav-item active" ><a class="nav-link" href="home/${id}/book.htm">CHI TIẾT 	<span class="sr-only">(current)</span></a></li>
