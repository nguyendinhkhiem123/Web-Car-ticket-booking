			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">SỬA THÔNG TIN TUYẾN XE</h2>
						<form:form method="POST" class="register-form" id="register-form"
							modelAttribute="tuyen" action="admin/${id }/list-order/update.htm">
								<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label>
								<form:input type="text" path="maTuyen" id="name" readonly="true"
									placeholder="Tên xe" />
								<form:errors path="maTuyen"></form:errors>
							</div>
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label>
