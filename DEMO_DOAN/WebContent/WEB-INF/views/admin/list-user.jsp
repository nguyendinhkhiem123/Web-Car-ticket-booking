...
<body id="page-top">
		...
		<table>
			...
			<c:forEach var="l" items="${list}">
				<tr>
					...
					<td>
					<c:choose>
						<c:when test="${l.role == 'admin'}">
							<a href="admin/${id}/list-user/update/${l.iD}.htm?lnkUpdate">
							Sửa </a> 
						</c:when>
						<c:otherwise>	
							<a href="admin/${id}/list-user/update/${l.iD}.htm?lnkUpdate">
							Sửa </a> 
							<a href="admin/${id}/list-user/delete/${l.iD}.htm?lnkDelete">
							Xóa </a>
						</c:otherwise>
					</c:choose>
					</td>
	...
	<div>
		<button class="btnThem"><a href="admin/${id}/list-user/insert.htm" id="signup">THÊM USER</a></button>
	</div>
